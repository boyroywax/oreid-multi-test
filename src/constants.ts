...
export const REACT_APP_OREID_APP_ID: string = process.env.REACT_APP_OREID_APP_ID || ""

// Faucet keys
export const REACT_APP_TREASURY_OREID: string = process.env.REACT_APP_TREASURY_OREID || ""
export const REACT_APP_TREASURY_OWNER_PUB_KEY: string = process.env.REACT_APP_TREASURY_OWNER_PUB_KEY || ""
export const REACT_APP_TREASURY_OWNER_PRIV_KEY: string = process.env.REACT_APP_TREASURY_OWNER_PRIV_KEY || ""
export const REACT_APP_TREASURY_ACTIVE_PUB_KEY: string = process.env.REACT_APP_TREASURY_ACTIVE_PUB_KEY || ""
export const REACT_APP_TREASURY_ACTIVE_PRIV_KEY: string = process.env.REACT_APP_TREASURY_ACTIVE_PRIV_KEY || ""
export const REACT_APP_APPOREID_ACTIVE_KEY: string = process.env.REACT_APP_APPOREID_ACTIVE_KEY || "" 
